...
public class StudyPlans extends Fragment {
    EditText name, date;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        req = (View) inflater.inflate(R.layout.fragment_study_plans, container, false);
        name = (EditText) req.findViewById(R.id.name);
        date = (EditText) req.findViewById(R.id.date);
        ...
        insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Boolean checkinsertdata = DB.insertstudyplandata(nameTXT, dateTXT);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Boolean checkupdatedata = DB.updatestudyplandata(nameTXT, dateTXT);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setTitle("StudyPlan Entries");
