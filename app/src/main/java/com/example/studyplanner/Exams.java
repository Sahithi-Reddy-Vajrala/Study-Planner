...
public class Exams extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        req = (View) inflater.inflate(R.layout.fragment_exams, container, false);
        ...
        insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Boolean checkinsertdata = DB.insertexamdata(nameTXT, dateTXT);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Boolean checkupdatedata = DB.updateexamdata(nameTXT, dateTXT);
