...
public class Lectures extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        req = (View) inflater.inflate(R.layout.fragment_lectures, container, false);
        ...
        insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Boolean checkinsertdata = DB.insertlecturedata(nameTXT, dateTXT);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Boolean checkupdatedata = DB.updatelecturedata(nameTXT, dateTXT);
